...
from odoo.addons.payment_redsys_v1.controllers.main import RedsysController
...
class PaymentTransaction(models.Model):
    ...
    redsys_payment_ref = fields.Char(string="Redsys Payment Reference")
    #PASO1
    ...
    #PASO3 - LUEGO DE LA CONFIRMACION DE PAGO
